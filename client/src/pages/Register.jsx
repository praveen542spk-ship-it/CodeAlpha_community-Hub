      ...
      <div className="w-full max-w-md glass-glow rounded-3xl p-8 md:p-10 flex flex-col gap-6 animate-fade-in-up">
        ...
        <div className="flex flex-col gap-2 text-center">
          ...
          <p className="text-gray-400 text-sm font-sans">
            Create an account to join and collaborate in meeting rooms
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-gray-300 text-xs font-semibold uppercase tracking-wider font-display">Username</label>
